...
function ConditionBox() {
  ...
  return (
    <>
      <HightlightBox style="col-[1_/_2]" title="Humidity">
        <HighlightItem figure={`${humidity}`} unit="%" icon={<WiHumidity />} />
      </HightlightBox>
      <HightlightBox style="col-[2_/_3]" title="Pressure">
        <HighlightItem
          figure={`${pressure}`}
          unit="hPa"
          icon={<MdOutlineWaves />}
      ...
      <HightlightBox style="col-[3_/_4]" title="Visibility">
        <HighlightItem
          figure={`${visibility / 1000}km`}
          icon={<MdOutlineVisibility />}
        />
      </HightlightBox>
      <HightlightBox style="col-[4_/_5]" title="Feels like">
        <HighlightItem
          figure={`${feels_like}`}
          unit={<WiCelsius />}
